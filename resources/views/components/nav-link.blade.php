...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center justify-center text-center px-1 pt-1 border-b-2 border-yellow-600 text-sm font-medium
                leading-5
                text-yellow-700 focus:outline-hidden focus:border-indigo-700 transition duration-150 ease-in-out'
