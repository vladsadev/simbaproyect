<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-auth.form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Add Team Member') }}
                </x-slot>
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-auth.input id="email" type="email" class="mt-1 block w-full" wire:model="addTeamMemberForm.email" />
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <x-auth.input-error for="role" class="mt-2" />
