...
//     constructor() {
//         // Contar los checkboxes reales en la página
//         const checkboxes = document.querySelectorAll('.inspection-check');
//         this.totalItems = checkboxes.length || 10; // Default a 10 si no hay checkboxes
//         this.checkedItems = 0;
//         this.reportedIssues = new Map();
//         this.init();
//     }
//
//     init() {
...
//                 ? (this.checkedItems / this.totalItems) * 100
//                 : 0;
//
